...
class EventCreateRequestDtoTests {

  @Test
  void shouldReadAndWriteJson() {
    val inputJson = "{\"calendarId\":\"test-id\","
        + "\"title\":\"title\","
        ...
        + "\"userId\":\"3caf687f-b00e-479f-9255-9aaebdf1191f\","
        + "\"language\":\"en\"}},"
        + "\"dataSource\":null}";

    JsonTestHelper.shouldReadAndWriteJson(inputJson, EventCreateRequestDto.class,  (json, dto) -> {
